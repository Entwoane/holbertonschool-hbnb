...
class Place(BaseModel):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'owner_first_name': self.owner.first_name if self.owner else None,
            ...
            'reviews': [{'user_id': review.user_id, 'text': review.text, 'rating': review.rating} for review in self.reviews],
